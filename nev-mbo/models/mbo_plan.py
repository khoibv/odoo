...
class MboPlan(models.Model):
    ...
    status = fields.Selection(
        [('none', 'None'), ('updating', 'Updating'), ('wait for review', 'Wait For Review'), ('approved', 'Approved'),
         ('doing', 'Doing'), ('evaluating', 'Evaluating'), ('finished', 'Finished')],
        string=_("Status Of MBO"),
